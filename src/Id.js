...
export default class Id {
     ...
     * @parameter {integer} [firstgid=0] - The base tile to return for this run of frames.
     * @returns {Id.Tiler} - A tiler over this set of IDs.
     */
    static tiler(projection, pattern, firstgid=0) {
        return (wangId) => pattern[projection(wangId)] + firstgid;
    }
}
 ...
 *
 * The key is the wangId "pointing towards" the corner from a putative middle tile. The values are the adjacent sides to that corner. For instance, gien the `NE` corner, we care about connections to the north, east, and northeast.
 */
Id.STI = {
